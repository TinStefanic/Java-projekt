...
public class FloydWarshallAlgorithmTest {
    ...
    public FloydWarshallAlgorithmTest() {
        g = new Graph(6);
        g.addEdge(0, 1, 1);
        g.addEdge(0, 2, 2);
        g.addEdge(1, 2, 3);
    ...
    /**
     * Test of runAlgorithm method, of class FloydWarshallAlgorithm.
     */
    @Test
    public void testRunAlgorithm() {
        FloydWarshallAlgorithm instance = new FloydWarshallAlgorithm(g);
    ...
    /**
     * Test of getShortestPath method, of class FloydWarshallAlgorithm.
     */
    @Test
